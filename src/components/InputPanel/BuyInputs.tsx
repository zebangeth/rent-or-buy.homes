...
export default function BuyInputs({ onSwitchToRent }: BuyInputsProps) {
  ...
  const handleInputChange = <K extends keyof BuyInputsType>(
    field: K, 
    value: BuyInputsType[K]
  ) => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex justify-between items-center mb-3">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="w-16 px-2 py-1 text-sm font-semibold text-primary-700 bg-primary-100 border border-primary-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-300 text-center"
              min="0"
              max="100"
              step="1"
            />
        ...
        <div className="flex justify-between items-center mb-3">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={(e) => handleNumberInputChange('mortgageInterestRateAnnual', e.target.value, (val) => Number(val))}
      ...
      <div>
        ...
        <div className="text-xs text-dark-400 mt-1 italic">
          Based on historical average in your selected area
        </div>
      </div>
      ...
      <div className="mt-4 border-t border-gray-100 pt-4">
        ...
        {showAdvanced && (
          <div className="mt-4 space-y-4 bg-gray-50 p-4 rounded-xl">
            ...
            <div className="text-xs font-semibold text-dark-600 mb-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-2 items-center">
                <input
                  ...
                  onChange={(e) => handleNumberInputChange('closingCostsPercentageBuy', e.target.value, (val) => Number(val))}
                  onBlur={() => handleNumberInputBlur('closingCostsPercentageBuy', (val) => Number(val))}
                  className="w-16 p-1.5 text-xs text-center border rounded-lg"
                />
                <span className="text-xs text-dark-500">%</span>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-2 items-center">
                <input
                  ...
                  onChange={(e) => handleNumberInputChange('sellingCostsPercentageSell', e.target.value, (val) => Number(val))}
            ...
            <div className="text-xs font-semibold text-dark-600 mb-2 mt-4">
              Holding Costs
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-2 items-center">
                <input
                  ...
                  step="0.1"
                  onChange={(e) => handleNumberInputChange('propertyTaxRateAnnual', e.target.value, (val) => Number(val))}
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-2 items-center">
                <input
                  ...
                  step="0.1"
                  onChange={(e) => handleNumberInputChange('insuranceAndMaintenanceRateAnnual', e.target.value, (val) => Number(val))}
            ...
            {/* HOA Fee */}
            <div className="flex justify-between items-center">
              <label className="text-xs font-medium text-dark-600">Annual HOA Fee</label>
              <div className="flex space-x-2 items-center">
                <span className="text-xs text-dark-500">$</span>
                <input
                  type="text"
                  ...
                  className="w-20 p-1.5 text-xs text-center border rounded-lg"
                  placeholder="5,000"
                />
              </div>
            </div>
              ...
              <div className="flex items-center">
                <label className="flex items-center cursor-pointer">
                  <div className="relative">
                    ...
                    <div className={`dot absolute left-0.5 top-0.5 bg-white w-3 h-3 rounded-full transition-transform ${
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-2 items-center">
                <input
                  ...
                  onChange={(e) => handleNumberInputChange('longTermCapitalGainsTaxRateProperty', e.target.value, (val) => Number(val))}
